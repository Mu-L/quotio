public struct AccountLoginSource: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(accountID: String, source: AccountSource, credentialReference: String?, status: AccountStatus, location: String? = nil, enabled: Bool? = nil, actions: Set<String>? = nil, keychainAccount: String? = nil) {
