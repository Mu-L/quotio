...
export class UniversalProviderService {
  ...
  addProvider(provider: Omit<UniversalProvider, "id" | "createdAt" | "updatedAt">): UniversalProvider {
  ...
  updateProvider(id: string, updates: Partial<UniversalProvider>): UniversalProvider | undefined {
